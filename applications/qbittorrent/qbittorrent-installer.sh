...
mv ./tmp/*.AppImage ./;
rm -R tmp
mv ./*.AppImage ./qbittorrent;
echo "[Desktop Entry]
Categories=Network;FileTransfer;P2P;Qt;
Exec=/opt/bin/qbittorrent %U
...
Name[th]=qBittorrent" >> /home/$USER/.local/share/applications/qbittorrent.desktop;
wget wget https://raw.githubusercontent.com/ivan-hc/AppMan/main/applications/qbittorrent/qbittorrent.svg;
mv ./qbittorrent.svg /home/$USER/.local/share/icons/;
rm /opt/bin/qbittorrent-installer
