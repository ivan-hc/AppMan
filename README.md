...
- `coreutils`
- `curl`
- `fuse` (optional for AppMan and AM, but strongly required by AppImages to run, learn more at [https://docs.appimage.org](https://docs.appimage.org/user-guide/troubleshooting/fuse.html))
- `grep`
- `sed`
- `tar`
- `unzip`
